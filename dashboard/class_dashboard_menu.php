<?php 
$dashboard_menu= new dashboard_menu; //instanisasi class form
...
function form_add(){
	if($_POST && $_GET['f']=="addmenu") {
	$this->add();
	}
else if (!$_POST && $_GET['f']=="addmenu"){
?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
...
function form_edit(){
if($_POST && $_GET['f']=="editmenu") {
$this->edit();
}
else if (!empty($_GET['id'])){
foreach ($this->db->get_Menu_Where("ID",$_GET['id']) as $value){
?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
...
function add(){
$this->db->add_Menu(htmlentities($_POST['name']),htmlentities($_POST['link']),htmlentities($_POST['orderby']));
?>
...
function edit(){
$this->db->set_Menu_Where(htmlentities($_POST['id']),"name",htmlentities($_POST['name']));
$this->db->set_Menu_Where(htmlentities($_POST['id']),"link",htmlentities($_POST['link']));
$this->db->set_Menu_Where(htmlentities($_POST['id']),"order by",htmlentities($_POST['orderby']));
?>
...
function delete(){
$this->db->del_Menu_Where("ID",htmlentities($_POST['id']));
?>
